package App::Crawler::Util::CustomFields;

use App::Crawler; # a no-op except needed for testing

use Dancer ':syntax';
use Dancer::Plugin::DBIC;

use App::Crawler::DB::ResultSet::Device;
use App::Crawler::DB::ResultSet::DevicePort;
...
{
  package App::Crawler::DB::ResultSet::Device;
...
{
  package App::Crawler::DB::ResultSet::DevicePort;
