package App::Crawler::Util::Snapshot;

use Dancer qw/:syntax :script/;
use Dancer::Plugin::DBIC 'schema';

use App::Crawler::Util::SNMP qw/get_mibdirs sortable_oid/;
...
sub load_cache_for_device {
  ...
  my $pseudo_cache = catfile( catdir(($ENV{CRAWLER_HOME} || $ENV{HOME}), 'logs', 'snapshots'), $device->ip );
