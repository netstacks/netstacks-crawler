package App::Crawler::Util::SNMP;

use Dancer qw/:syntax :script/;
use App::Crawler::Util::DeviceAuth 'get_external_credentials';
...
sub get_mibdirs {
  my $home = (setting('mibhome') || dir(($ENV{CRAWLER_HOME} || $ENV{HOME}), 'netdisco-mibs'));
