package App::Crawler::Worker::Plugin::Discover::PortProperties;
...
use App::Crawler::Util::PortAccessEntity 'update_pae_attributes';
use App::Crawler::Util::FastResolver 'hostnames_resolve_async';
use App::Crawler::Util::Device qw/is_discoverable match_to_setting/;
