package App::Crawler::Worker::Plugin::Discover::Neighbors;
...
use App::Crawler::Util::Device qw/get_device is_discoverable match_to_setting/;
...
sub set_manual_topology {
  my $device = shift;
  my $snmp = App::Crawler::Transport::SNMP->reader_for($device) or return;
