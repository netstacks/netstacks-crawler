package App::Crawler::Worker::Plugin::Macsuck::Nodes;

use Dancer ':syntax';
use App::Crawler::Worker::Plugin;
use aliased 'App::Crawler::Worker::Status';

use App::Crawler::Transport::SSH ();
use App::Crawler::Transport::SNMP ();
use App::Crawler::Util::Permission 'acl_matches';
use App::Crawler::Util::PortMAC 'get_port_macs';
use App::Crawler::Util::Device 'match_to_setting';
use App::Crawler::Util::Node 'check_mac';
use App::Crawler::Util::SNMP 'snmp_comm_reindex';
...
register_worker({ phase => 'main', driver => 'cli',
  ...
  my $cli = App::Crawler::Transport::SSH->session_for($device)
