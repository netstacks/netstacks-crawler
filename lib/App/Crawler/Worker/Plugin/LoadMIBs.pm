package App::Crawler::Worker::Plugin::LoadMIBs;
...
use App::Crawler::Util::Snapshot 'make_snmpwalk_browsable';
# use DDP;
...
register_worker({ phase => 'main' }, sub {
  ...
  my $home = (setting('mibhome') || catdir(($ENV{CRAWLER_HOME} || $ENV{HOME}), 'netdisco-mibs'));
