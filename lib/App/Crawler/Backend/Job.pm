package App::Crawler::Backend::Job;
...
Passed an L<App::Crawler::Worker::Status> will add it to this job's internal
...
sub add_status {
  my ($job, $status) = @_;
  return unless ref $status eq 'App::Crawler::Worker::Status';
...
L<App::Crawler::DB::Result::Admin> class.
