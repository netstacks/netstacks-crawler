package App::Crawler::JobQueue::PostgreSQL;

use Dancer qw/:moose :syntax :script/;
use Dancer::Plugin::DBIC 'schema';

use App::Crawler::Util::Device 'get_denied_actions';
use App::Crawler::Backend::Job;
...
sub jq_getsome {
  ...
  while (my $job = $tasty->next) {
    ...
    push @returned, App::Crawler::Backend::Job->new({ $job->get_columns });
  }
