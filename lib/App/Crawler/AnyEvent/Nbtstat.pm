package App::Crawler::AnyEvent::Nbtstat;
...
App::Crawler::AnyEvent::Nbtstat - Request NetBIOS node status with AnyEvent

=head1 SYNOPSIS

    use App::Crawler::AnyEvent::Nbtstat;;

    my $request = App::Crawler::AnyEvent::Nbtstat->new();
...
L<App::Crawler::AnyEvent::Nbtstat> is an asynchronous AnyEvent NetBIOS node
status requester.

=head1 ATTRIBUTES

L<App::Crawler::AnyEvent::Nbtstat> implements the following attributes.
...
L<App::Crawler::AnyEvent::Nbtstat> implements the following methods.
