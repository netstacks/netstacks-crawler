package App::Crawler::DB::ExplicitLocking;
...
App::Crawler::DB::ExplicitLocking - Support for PostgreSQL Lock Modes
...
In your L<DBIx::Class> schema:
 ...
 package My::Schema;
 __PACKAGE__->load_components('+App::Crawler::DB::ExplicitLocking');
