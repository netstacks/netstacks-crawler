use utf8;
package App::Crawler::DB::Result::DevicePortVlan;
...
__PACKAGE__->belongs_to( port => 'App::Crawler::DB::Result::DevicePort', {
...
__PACKAGE__->belongs_to( vlan_entry => 'App::Crawler::DB::Result::DeviceVlan', {
