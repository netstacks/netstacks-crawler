use utf8;
package App::Crawler::DB::Result::NodeIp;
...
__PACKAGE__->belongs_to( router => 'App::Crawler::DB::Result::Device',
  sub {
      my $args = shift;
      return {
...
__PACKAGE__->has_many( node_ips => 'App::Crawler::DB::Result::NodeIp',
...
__PACKAGE__->has_many( netbios => 'App::Crawler::DB::Result::NodeNbt',
  { 'foreign.mac' => 'self.mac' } );
