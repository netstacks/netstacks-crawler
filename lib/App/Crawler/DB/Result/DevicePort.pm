use utf8;
package App::Crawler::DB::Result::DevicePort;
...
__PACKAGE__->belongs_to( device => 'App::Crawler::DB::Result::Device', 'ip' );
...
__PACKAGE__->has_many( port_vlans => 'App::Crawler::DB::Result::DevicePortVlan',
...
__PACKAGE__->has_many( nodes => 'App::Crawler::DB::Result::Node',
  {
...
__PACKAGE__->has_many( nodes_with_age => 'App::Crawler::DB::Result::Virtual::NodeWithAge',
  {
    'foreign.switch' => 'self.ip',
    'foreign.port' => 'self.port',
  },
...
__PACKAGE__->has_many( active_nodes => 'App::Crawler::DB::Result::Virtual::ActiveNode',
  {
    'foreign.switch' => 'self.ip',
    'foreign.port' => 'self.port',
  },
...
__PACKAGE__->has_many( active_nodes_with_age => 'App::Crawler::DB::Result::Virtual::ActiveNodeWithAge',
  {
    'foreign.switch' => 'self.ip',
    'foreign.port' => 'self.port',
  },
...
__PACKAGE__->has_many( logs => 'App::Crawler::DB::Result::DevicePortLog',
  { 'foreign.ip' => 'self.ip', 'foreign.port' => 'self.port' },
);
...
__PACKAGE__->might_have( power => 'App::Crawler::DB::Result::DevicePortPower', {
  'foreign.ip' => 'self.ip', 'foreign.port' => 'self.port',
});
...
__PACKAGE__->might_have( properties => 'App::Crawler::DB::Result::DevicePortProperties', {
  'foreign.ip' => 'self.ip', 'foreign.port' => 'self.port',
});
...
__PACKAGE__->might_have(
    ssid => 'App::Crawler::DB::Result::DevicePortSsid',
    {   'foreign.ip'   => 'self.ip',
        'foreign.port' => 'self.port',
    }
);
...
__PACKAGE__->might_have(
    wireless => 'App::Crawler::DB::Result::DevicePortWireless',
    {   'foreign.ip'   => 'self.ip',
        'foreign.port' => 'self.port',
    }
);
...
__PACKAGE__->belongs_to(
    native_vlan => 'App::Crawler::DB::Result::DeviceVlan',
    sub {
        my $args = shift;
        return {
...
__PACKAGE__->belongs_to(
    agg_master => 'App::Crawler::DB::Result::DevicePort', {
      'foreign.ip'   => 'self.ip',
...
__PACKAGE__->belongs_to( neighbor_alias => 'App::Crawler::DB::Result::DeviceIp',
  sub {
      my $args = shift;
      return {
...
__PACKAGE__->belongs_to(
    last_node => 'App::Crawler::DB::Result::Virtual::LastNode', {
      'foreign.switch' => 'self.ip',
      'foreign.port'   => 'self.port',
    }, {
      join_type => 'LEFT',
...
__PACKAGE__->belongs_to( oui => 'App::Crawler::DB::Result::Oui',
  sub {
      my $args = shift;
      return {
...
__PACKAGE__->belongs_to( manufacturer => 'App::Crawler::DB::Result::Manufacturer',
  sub {
      my $args = shift;
      return {
