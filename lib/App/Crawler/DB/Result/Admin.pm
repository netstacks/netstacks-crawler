use utf8;
package App::Crawler::DB::Result::Admin;
...
__PACKAGE__->might_have( device_skips => 'App::Crawler::DB::Result::DeviceSkip',
  sub {
    my $args = shift;
    return {
...
__PACKAGE__->belongs_to( target => 'App::Crawler::DB::Result::Device',
