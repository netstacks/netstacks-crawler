use utf8;
package App::Crawler::DB::Result::Node;
...
__PACKAGE__->belongs_to( device => 'App::Crawler::DB::Result::Device',
...
__PACKAGE__->belongs_to( device_port => 'App::Crawler::DB::Result::DevicePort',
...
__PACKAGE__->belongs_to(
    wireless_port => 'App::Crawler::DB::Result::DevicePortWireless',
    { 'foreign.ip' => 'self.switch', 'foreign.port' => 'self.port' },
    { join_type    => 'LEFT' }
);
...
__PACKAGE__->has_many( ips => 'App::Crawler::DB::Result::NodeIp',
...
__PACKAGE__->has_many( ip4s => 'App::Crawler::DB::Result::Virtual::NodeIp4',
  { 'foreign.mac' => 'self.mac', 'foreign.active' => 'self.active' } );
...
__PACKAGE__->has_many( ip6s => 'App::Crawler::DB::Result::Virtual::NodeIp6',
  { 'foreign.mac' => 'self.mac', 'foreign.active' => 'self.active' } );
...
__PACKAGE__->might_have( netbios => 'App::Crawler::DB::Result::NodeNbt',
...
__PACKAGE__->has_many( wireless => 'App::Crawler::DB::Result::NodeWireless',
  { 'foreign.mac' => 'self.mac' } );
...
__PACKAGE__->belongs_to( oui => 'App::Crawler::DB::Result::Oui', 'oui',
  { join_type => 'LEFT' } );
