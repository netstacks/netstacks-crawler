package App::Crawler::DB::Result::Virtual::DeviceLinks;
...
__PACKAGE__->has_many('left_vlans', 'App::Crawler::DB::Result::DevicePortVlan',
  sub {
    my $args = shift;
    return {
...
__PACKAGE__->has_many('right_vlans', 'App::Crawler::DB::Result::DevicePortVlan',
  sub {
    my $args = shift;
    return {
