use utf8;
package App::Crawler::DB::Result::DeviceVlan;
...
__PACKAGE__->has_many( port_vlans_tagged => 'App::Crawler::DB::Result::DevicePortVlan',
    sub {
      my $args = shift;
      return {
...
__PACKAGE__->has_many( port_vlans_untagged => 'App::Crawler::DB::Result::DevicePortVlan',
    sub {
      my $args = shift;
      return {
        "$args->{foreign_alias}.ip"   => { -ident => "$args->{self_alias}.ip" },
...
__PACKAGE__->has_many( ports => 'App::Crawler::DB::Result::DevicePortVlan',
