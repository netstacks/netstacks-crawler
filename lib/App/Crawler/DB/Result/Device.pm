use utf8;
package App::Crawler::DB::Result::Device;
...
__PACKAGE__->has_many( device_ips => 'App::Crawler::DB::Result::DeviceIp', 'ip' );
...
__PACKAGE__->has_many( device_ips_by_address_or_name => 'App::Crawler::DB::Result::DeviceIp',
  sub {
    my $args = shift;
    return {
...
__PACKAGE__->has_many( vlans => 'App::Crawler::DB::Result::DeviceVlan', 'ip' );
...
__PACKAGE__->has_many( ports => 'App::Crawler::DB::Result::DevicePort', 'ip' );
...
__PACKAGE__->has_many( ports_by_mac => 'App::Crawler::DB::Result::DevicePort',
  sub {
    my $args = shift;
    return {
      "$args->{foreign_alias}.ip" => { -ident => "$args->{self_alias}.ip" },
...
__PACKAGE__->has_many( module_serials => 'App::Crawler::DB::Result::DeviceModule',
  sub {
    my $args = shift;
    return {
      "$args->{foreign_alias}.ip" => { -ident => "$args->{self_alias}.ip" },
...
__PACKAGE__->has_many( modules => 'App::Crawler::DB::Result::DeviceModule', 'ip' );
...
__PACKAGE__->has_many( power_modules => 'App::Crawler::DB::Result::DevicePower', 'ip' );
...
__PACKAGE__->has_many( oids => 'App::Crawler::DB::Result::DeviceBrowser', 'ip' );
...
__PACKAGE__->has_many(
    port_vlans => 'App::Crawler::DB::Result::DevicePortVlan',
    'ip', { join_type => 'RIGHT' }
);
...
__PACKAGE__->has_many(
    port_vlans_filter => 'App::Crawler::DB::Result::DevicePortVlan',
    'ip', { join_type => 'INNER' }
);
...
__PACKAGE__->has_many(
    wireless_ports => 'App::Crawler::DB::Result::DevicePortWireless',
    'ip', { join_type => 'RIGHT' }
);
...
__PACKAGE__->has_many(
    ssids => 'App::Crawler::DB::Result::DevicePortSsid',
    'ip', { join_type => 'RIGHT' }
);
...
__PACKAGE__->has_many(
    properties_ports => 'App::Crawler::DB::Result::DevicePortProperties',
    'ip', { join_type => 'RIGHT' }
);
...
__PACKAGE__->has_many(
    powered_ports => 'App::Crawler::DB::Result::DevicePortPower',
    'ip', { join_type => 'RIGHT' }
);
...
__PACKAGE__->might_have(
    community => 'App::Crawler::DB::Result::Community', 'ip');
...
__PACKAGE__->has_one(
    throughput => 'App::Crawler::DB::Result::Virtual::DevicePortSpeed', 'ip');
