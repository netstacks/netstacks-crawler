use utf8;
package App::Crawler::DB::Result::DeviceBrowser;
...
__PACKAGE__->belongs_to(
  snmp_object => 'App::Crawler::DB::Result::SNMPObject',
  sub {
    my $args = shift;
    return {
...
__PACKAGE__->belongs_to( oid_fields => 'App::Crawler::DB::Result::SNMPObject', 'oid', { join_type => 'left' } );
