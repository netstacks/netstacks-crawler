package App::Crawler::Transport::SNMP;

use Dancer qw/:syntax :script/;
use Dancer::Plugin::DBIC 'schema';

use App::Crawler::Util::SNMP qw/get_communities get_mibdirs/;
use App::Crawler::Util::Device 'get_device';
use App::Crawler::Util::Permission 'acl_matches';
use App::Crawler::Util::Snapshot qw/load_cache_for_device add_snmpinfo_aliases fixup_browser_from_aliases/;
...
given device IP, or else undef. All methods are class methods, for example:
 ...
 my $snmp = App::Crawler::Transport::SNMP->reader_for( ... );
