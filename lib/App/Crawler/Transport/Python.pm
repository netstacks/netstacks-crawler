package App::Crawler::Transport::Python;

use Dancer qw/:syntax :script/;

use base 'Dancer::Object::Singleton';
use aliased 'App::Crawler::Worker::Status';
use App::Crawler::Util::Python 'py_cmd';
...
instruction to run worklets.
 ...
 my $runsub = App::Crawler::Transport::Python->py_worklet();
...
sub py_worklet {
  ...
  $ENV{'ND2_FSM_TEMPLATES'} = Path::Class::Dir->new( dist_dir('App-Crawler') )
