package App::Crawler::Transport::SSH;
...
for some actions such as arpnip.
 ...
 my $cli = App::Crawler::Transport::SSH->session_for( ... );
...
sub session_for {
  ...
  my $platform = "App::Crawler::SSHCollector::Platform::" . $auth->{platform};
  my $happy = false;
  try {
