package App::Crawler::Web::API::Queue;
...
swagger_path {
  ...
  responses => { default => {} },
}, get '/api/queue/backends' => require_role api_admin => sub {
...
swagger_path {
  ...
  responses => { default => {} },
}, get '/api/queue/jobs' => require_role api_admin => sub {
...
swagger_path {
  ...
  responses => { default => {} },
}, del '/api/queue/jobs' => require_role api_admin => sub {
...
swagger_path {
  ...
  responses => { default => {} },
}, post '/api/queue/jobs' => require_any_role [qw(api_admin port_control)] => sub {
